...
public class DataTables_StepDefinitions {
    ...
    public void i_will_share_my_favorites(List<String> listOfAnimals) {
    ...
    public void user_should_see_below_info_in_month_dropdown(List<String> expectedMonths) {
        ...
        Assert.assertEquals(expectedMonths, actualMonths); //expected coming from the feature file , actual is coming from list of elements that we created from the browser.
